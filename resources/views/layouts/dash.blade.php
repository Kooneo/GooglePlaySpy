...
<head>
    ...
    <title>Huro :: Ecommerce Dashboard</title>
...
<div id="huro-app" class="app-wrapper">
    ...
    <div class="main-sidebar">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="icon-menu">
                ...
                <li>
                    <a href="{{ route('top-apps') }}" id="layouts-sidebar-menu" data-content="Layouts">
    ...
    <script src="{{ asset('assets/js/ecommerce-1.js') }}" async></script>
